...
class GradientBoostingTreeClassifier (override val uid: String)
  extends ProbabilisticClassifier[Vector, GradientBoostingTreeClassifier, GradientBoostingClassificationModel]
...
@Since("1.4.0")
object GradientBoostingTreeClassifier extends DefaultParamsReadable[GradientBoostingTreeClassifier] {
...
class GradientBoostingClassificationModel private[ml](
  ...
  require(_trees.length == _treeWeights.length, "GradientBoostingClassificationModel given trees, treeWeights" +
  ...
  override def copy(extra: ParamMap): GradientBoostingClassificationModel = {
    copyValues(new GradientBoostingClassificationModel(uid, _trees, _treeWeights, numFeatures, numClasses),
  ...
  @Since("2.0.0")
  override def write: MLWriter = new GradientBoostingClassificationModel.GradientBoostingClassificationModelWriter(this)
}
...
object GradientBoostingClassificationModel extends MLReadable[GradientBoostingClassificationModel] {
  ...
  @Since("2.0.0")
  override def read: MLReader[GradientBoostingClassificationModel] = new GradientBoostingClassificationModelReader

  @Since("2.0.0")
  override def load(path: String): GradientBoostingClassificationModel = super.load(path)

  private[ml]
  class GradientBoostingClassificationModelWriter(instance: GradientBoostingClassificationModel) extends MLWriter {
  ...
  private class GradientBoostingClassificationModelReader extends MLReader[GradientBoostingClassificationModel] {
    ...
    override def load(path: String): GradientBoostingClassificationModel = {
      ...
      require(numTrees == trees.length, s"GradientBoostingClassificationModel.load expected $numTrees" +
  ...
  private[ml] def fromOld(
    ...
    new GradientBoostingClassificationModel(uid, newTrees, oldModel.treeWeights, numFeatures, numClasses)
  }
}
