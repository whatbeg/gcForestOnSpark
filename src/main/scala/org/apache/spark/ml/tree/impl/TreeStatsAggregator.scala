 ...
 */
private[spark] class TreeStatsAggregator(
  ...
  /**
    ...
    */
  private[impl] val statsSize: Int = impurityAggregator.statsSize
  ...
  /**
    ...
    */
  private[impl] val featureOffsets: Array[Int] = {
  ...
  /**
    ...
    */
  private[impl] val allStatsSize: Int = featureOffsets.last
  ...
  /**
    ...
    */
  private[impl] val allStats: Array[Double] = new Array[Double](allStatsSize)

  private[impl] def getAllStats(): Array[Double] = allStats
  ...
  /**
    ...
    */
  private[impl] val parentStats: Array[Double] = new Array[Double](statsSize)
  ...
  /**
    ...
    */
  def merge(other: TreeStatsAggregator): TreeStatsAggregator = {
    require(allStatsSize == other.allStatsSize,
      s"TreeStatsAggregator.merge requires that both aggregators" +
        s" have the same length stats vectors."
        + s" This aggregator is of length $allStatsSize," +
        s" but the other is ${other.allStatsSize}.")
    //    BLAS.axpy(1, other.allStats, allStats)
    var i = 0
    // TODO: Test BLAS.axpy
    ...
    require(statsSize == other.statsSize,
      s"TreeStatsAggregator.merge requires that both aggregators have the same length parent " +
        s"stats vectors. This aggregator's parent stats are length $statsSize, " +
        s"but the other is ${other.statsSize}.")
    //    BLAS.axpy(1, other.parentStats, parentStats)
    var j = 0
    while (j < statsSize) {
